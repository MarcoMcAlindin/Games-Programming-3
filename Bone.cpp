...
int Bone::GetPositionIndex(float animationTime)
{
    ...
    {
        if (animationTime < m_Positions[static_cast<INT64>(index) + 1].timeStamp)
            return index;
    }
    assert(0);
}
...
int Bone::GetRotationIndex(float animationTime)
{
    ...
    {
        if (animationTime < m_Rotations[static_cast<INT64>(index) + 1].timeStamp)
            return index;
    }
    assert(0);
}
...
int Bone::GetScaleIndex(float animationTime)
{
    ...
    {
        if (animationTime < m_Scales[static_cast<INT64>(index) + 1].timeStamp)
            return index;
    }
    assert(0);
}
