...
private:
	...
	glm::vec3 m_translate = glm::vec3(0.f,0.f,0.f);
...
public:
	...
	inline void SetTransXYZ(glm::vec3 transXYZ) { m_isDirty = true; m_translate = transXYZ; }
	inline glm::vec3 GetTransXYZ() { m_isDirty = true; return m_translate; }
